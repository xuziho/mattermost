...
func TestGetLicenseSkuName(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name:             "nil license",
			license:          nil,
			expectedSku:      "AgentCompanyOS",
			expectedPrefixed: "AgentCompanyOS",
		},
		{
			name:             "empty sku name",
		...
		},
		{
			...
			expectedSku:      "E10",
			expectedPrefixed: "AgentCompanyOS E10",
		},
		{
			name:             "E20",
			license:          &model.License{SkuName: "E20"},
			expectedSku:      "E20",
			expectedPrefixed: "AgentCompanyOS E20",
		},
	}
