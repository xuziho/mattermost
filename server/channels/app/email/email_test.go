	...
	tests := []struct {
		...
		expectedPrefixed string
	}{
			{
				name:             "nil license",
				license:          nil,
				expectedSku:      "TinyOffice",
				expectedPrefixed: "TinyOffice",
			},
			{
				name:             "empty sku name",
		...
		},
		{
			...
			expectedSku:      "E10",
				expectedPrefixed: "TinyOffice E10",
		},
		{
			name:             "E20",
			license:          &model.License{SkuName: "E20"},
			expectedSku:      "E20",
				expectedPrefixed: "TinyOffice E20",
		},
	}
