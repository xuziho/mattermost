...
export const Constants = {
    ...
    MHPNS_LEGACY_US: 'https://push-legacy-us.agentcompanyos.local',
    MHPNS_LEGACY_DE: 'https://push-legacy-eu.agentcompanyos.local',
    MHPNS_GLOBAL: 'https://push.agentcompanyos.local',
    MHPNS_US: 'https://push-us.agentcompanyos.local',
    MHPNS_DE: 'https://push-eu.agentcompanyos.local',
    MHPNS_JP: 'https://push-ap.agentcompanyos.local',
    MTPNS: 'https://push-test.agentcompanyos.local',
    MAX_PREV_MSGS: 100,
