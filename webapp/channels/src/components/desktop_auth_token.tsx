    ...
    if (status === DesktopAuthStatus.LoggedIn) {
        ...
        subMessage = (
            <FormattedMessage
                ...
                defaultMessage='Click <b>Open</b> in the browser prompt to continue in the desktop client.'
                values={{
        ...
        bottomMessage = (
            <FormattedMessage
                ...
                defaultMessage='Having trouble logging in? <a>Continue in your browser</a>'
                values={{
                    a: (chunks: React.ReactNode) => {
                        return (
