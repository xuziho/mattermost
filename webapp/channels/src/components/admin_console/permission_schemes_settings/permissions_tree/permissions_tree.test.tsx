...
describe('components/admin_console/permission_schemes_settings/permission_tree', () => {
    ...
    test('should map groups in the correct order', () => {
        ...
        expect(groups[3].id).toStrictEqual('posts');
        expect(groups[4].id).toStrictEqual('integrations');
        expect(groups[5].id).toStrictEqual('manage_shared_channels');
        expect(groups[6].id).toStrictEqual('custom_groups');
    });
